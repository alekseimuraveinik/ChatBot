...
--------16.11.19--------------
1. Введение понятия локаций и персонажей, игровой мир теперь представляет из себя граф, вершинами которого являются или какие бы то ни было локации, или npc, с которыми можно взаимодействовать, или точкой входа в квест, который точно так же является частью графа
2. Введение характеристик персонажа: опыта, золота, предметов, репутации
3. Личные сообщения между пользователями, находящимися либо одной локации, либо в разных (механика "Почта") 
4. Использовать Mochito для тестирования
5. Использовать систему внедрения зависимостей (dagger или spring)
6. Использовать RxJava для подписки на приходящие из телеграмма сообщения
